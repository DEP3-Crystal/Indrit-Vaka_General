...
public class DataFromProperties {
    ...
    public static boolean saveProperty(DigitalVideoDisc disc) {
        try {
            OutputStream stream = new FileOutputStream("OnMediaStore_2/src/main/resources/media.properties");
    ...
    public static DigitalVideoDisc getProperties() {
        ...
        try {
            InputStream stream = new FileInputStream("OnMediaStore_2/src/main/resources/media.properties");
     ...
     * @return returns true if the data was saved successfully
     */
    public static boolean saveProperties(List<DigitalVideoDisc> list) {
        media.setProperty("list", list.toString());
        OutputStream stream;
        try {
            stream = new FileOutputStream("OnMediaStore_2/src/main/resources/mediaList.properties");
            media.store(stream, null);
            return true;
    ...
    public static List<DigitalVideoDisc> getPropertyList() {
        ...
        try {
            InputStream stream = new FileInputStream("OnMediaStore_2/src/main/resources/mediaList.properties");
            media.load(stream);
